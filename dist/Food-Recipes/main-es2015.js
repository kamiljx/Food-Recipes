...
function RecipeListComponent_a_6_Template(rf, ctx) { if (rf & 1) {
...
class RecipeListComponent {
    constructor() {
        this.recipes = [
            new _recipe_model__WEBPACK_IMPORTED_MODULE_1__["Recipe"]('Test Recipe', 'This is default description', 'https://www.hellomagazine.com/imagenes/cuisine//easy-chinese-new-year-recipes/0-514-324/chicken-a.jpg')
        ];
    }
    ngOnInit() {
    }
